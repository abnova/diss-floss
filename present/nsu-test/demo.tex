...
\graphicspath{{./}{images/}{/home/ruser/diss-floss/figures/}}

\usetheme{progressbar}
\progressbaroptions{headimage=LogoNSU3.jpg,titleimage=LogoNSU3.jpg}
...
\begin{frame}
  ...
  \begin{figure}[t]
    \centering
    \includegraphics[height=\dimexpr11\textheight/16\relax]{ggplot2ExamplePlot}
    \caption{Sample ggplot2 plot}
  \end{figure}
\end{frame}
