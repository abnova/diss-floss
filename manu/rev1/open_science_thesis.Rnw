...
\documentclass[
  ...
  colortheme=blue,
  pagelayout=oneside,
  titlepagetheme=plain,
  linespacing=doublespacing,
  justification=centered
]{ost/subdocuments/open_science_thesis}

% AB: The following is here just for reference:
% it's likely not a good idea to mix the OST document class
% with 'apa6' document class (might try it separately)
% \documentclass[options]{apa6}

% AB: I tried to switch to charter, but LaTeX produces an error
...
% AB: OST's alternative to 'biblatex-apa' package?
...
% AB: for inserting images into a document
\usepackage{graphicx}
\graphicspath{ {usr/graphics/static/} }

% AB: for flxible control of spacing
\usepackage{setspace}
