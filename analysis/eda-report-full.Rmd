...
chunkOptions <- "include=TRUE, results='asis', fig.height=4, fig.width=4, fig.cap='{{varName}}'"
...
#latexObjLabel <- paste0("cat('\\\\label{", bcRefStr$objType, ":{{varName}}", "}')")

latexObjLabel <- paste0("cat('\\\\caption{\\\\ ", "{{varName}}\\\\label{", bcRefStr$objType, ":{{varName}}", "}}')\n")
...
```{r NonDynamicChunk, include=TRUE, results='asis', fig.height=4, fig.width=5, fig.cap='EDA: Barcharts'}
