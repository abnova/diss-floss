...
genEFAresultsTable(caption="EFA parallel analysis scree plot", digits=2, numFactors=numFactors)
```
...
```{r efaReportDiagram, include=TRUE, results='asis', fig.cap='EFA Results: Diagrams\\label{fig:efaResultsDiagram}', fig.show='hold', fig.subcap=diagLegend}
