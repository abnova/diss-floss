...
```{r efaReportScreePlot, include=TRUE, fig.cap='EFA Report: Scree plot'}
...
```{r efaResultsDiagram, include=TRUE, results='asis', fig.cap='EFA Results Diagrams', fig.show='hold', fig.subcap=diagLegend}
genEFAresultsDiagram(faPA_flossData, latex = TRUE)
#genEFAresultsDiagram(faPromax_flossData, latex = TRUE)
```

```{r efaResultsDiagram2, include=FALSE, results='asis', fig.cap='EFA Results Diagrams (continued)', fig.show='hold', fig.height=3.5, fig.width=3.5}
genEFAresultsDiagram(faBi_flossData, latex = TRUE)
```

```{r efaResultsDiagram3, include=FALSE, results='asis', fig.cap='EFA Results Diagrams (continued)', fig.show='hold', fig.height=3.5, fig.width=3.5}
