...
genEFAresultsTable(caption="EFA parallel analysis scree plot", digits=2, numFactors)
```
...
```{r efaReportDiagram, include=TRUE, results='asis', fig.cap='EFA Results Diagrams', fig.show='hold', fig.subcap=diagLegend}
